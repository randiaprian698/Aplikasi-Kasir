...
penjualan ON pelanggan.PelangganID=penjualan.PelangganID");
                ...
                ?>
                    ...
                    <div class="modal fade" id="edit-data<?php echo
                                                            $d['PelangganID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" ariahidden="true">
                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="NamaPelanggan" value="<?php echo $d['NamaPelanggan']; ?>" class="formcontrol">
                                        </div>
                                        <div class="form-group">
                                            <label>No. Telepon</label>
                                            <input type="text" name="NomorTelepon" value="<?php echo $d['NomorTelepon']; ?>" class="formcontrol">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btnp-rimary">Simpan</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form method="post" action="proses_hapus_pembelian.php">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btnp-rimary">Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="PelangganID" value="<?php echo
                                                                        date("dmHis") ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nama Pelanggan</label>
