                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php } else { ?>
                                <button type="button" class="btn btn-danger btnsm" data-bs-toggle="modal" data-bs-target="#hapus-data<?php echo
                                                                                                                                        $d['id_petugas']; ?>">
                                    Hapus
                                </button>
                            <?php } ?>
                    ...
                    <div class="modal fade" id="edit-data<?php echo
                                                            $d['id_petugas']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger text-sm">*
                                                Kosongkan kalau tidak merubah password</small>
                                        </div>
                                        <div class="form-group">
